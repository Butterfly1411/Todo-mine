        ...
        <div className="min-h-screen flex items-center justify-center bg-[#101114] font-[Poppins,sans-serif] text-[#F9F9F9] px-5">
            <div className="bg-[#1C1D20] rounded-2xl shadow-lg p-10 w-full max-w-md">
                <h1 className="mb-8 text-3xl font-bold text-center">
                    Welcome to <br />
                    <span className="text-[#00FFC4] text-4xl font-extrabold">ToDo APP</span>
                </h1>
               ...
               focus:border-[#00FFC4]"
                ...
                {/* Login button */}
                <button className="w-full h-12 rounded-lg bg-[#00FFC4] text-[#101114] font-semibold hover:opacity-90 transition">
                    Login
                </button>
            </div>
        </div>
